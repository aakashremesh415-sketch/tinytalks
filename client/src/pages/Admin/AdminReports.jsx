            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-slate-400 mt-1">
                  Reported: <strong className="text-slate-200">{r.reportedUser.displayName || r.reportedUser.email || r.reportedUser.id}</strong>
                  {' '}by {r.reporter.displayName || r.reporter.email || r.reporter.id}
                </p>
                {r.description && <p className="text-sm text-slate-300 mt-2">"{r.description}"</p>}
                <span className="chip mt-2 bg-white/5 border-white/10 text-slate-300">{r.status}</span>
